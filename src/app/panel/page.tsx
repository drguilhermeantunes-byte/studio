...
import { collection, query, orderBy, limit, serverTimestamp, addDoc, doc, deleteDoc } from 'firebase/firestore';
...
export default function PanelPage() {
    ...
    const confirmDelete = async () => {
        if (!callToDelete || !firestore) return;
        try {
            const callDocRef = doc(firestore, 'calls', callToDelete.id);
                ...
                <div className="container mx-auto grid max-w-7xl grid-cols-1 items-start gap-8 lg:grid-cols-2">
                    ...
                    <Card className="border-2 border-border/50 shadow-lg">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Clique em repetir para preencher o formulário ou na lixeira para deletar.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <RecentCalls 
                                ...
                                onDeleteCall={(call) => setCallToDelete(call)}
                            />
                        </CardContent>
                    </Card>
                </div>
